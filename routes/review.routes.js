...
reviewRouter.put("/update-review-status/:id", review_controller_1.default.updateReviewStatus);
reviewRouter.delete("/delete-reviews/:id", review_controller_1.default.deleteReview);
reviewRouter.get("/get-all-reviews", review_controller_1.default.getAllReviews);
reviewRouter.get("/get-reviews", review_controller_1.default.getReviews);
